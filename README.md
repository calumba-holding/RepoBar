...
RepoBar also has RepoBar-owned GitHub archive configuration for Discrawl-compatible snapshot databases. It does not read gitcrawl config or modify gitcrawl databases.
